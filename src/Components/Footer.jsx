    ...
    return (
        <footer className="bg-[#1E293B] text-white py-4  px-4 text-center">
            <div className="max-w-4xl mx-auto flex flex-col pb-2 items-center">
                ...
                />
                {/* <h1 className="text-green-400 text-5xl font-cursive mb-4">Portfolio</h1> */}
                ...
                <div className="flex space-x-5 mb-6">
                    <a
                        href="#"
                        className="p-3 bg-[#2D3748] text-gray-300 rounded-lg shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-green-400"
                    >
                        <FaTiktok size={22} />
                    </a>
                    <a
                        href="#"
                        className="p-3 bg-[#2D3748] text-red-500 rounded-lg shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-green-400 "
                    >
                        <FaYoutube size={22} />
                    </a>
                    <a
                        href="#"
                        className="p-3 bg-[#2D3748] text-[#1877F2] rounded-lg shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-green-400 "
                    >
                        <FaFacebook size={22} />
                    </a>
                    <a
                        href="#"
                        className="p-3 bg-[#2D3748] text-pink-500 rounded-lg shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-green-400 "
                    >
                        <FaInstagram size={22} />
                    </a>
                </div>
